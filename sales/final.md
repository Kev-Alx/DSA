...
![Category Revenue Visual](outputs/images/image_003.png)
...
![Category Revenue Visual](outputs/md-only-img/s1.png)

![Category Revenue Visual](outputs/images/image_013.png)
...
| :----------------------------------------------: | :---------------------------------------------: |
| ![Monthly Revenue](outputs/images/image_007.png) | ![Orders Heatmap](outputs/images/image_008.png) |
...
![Distribution of Purchase Frequency](outputs/images/image_011.png)

![When Do Repeat Customers Return?](outputs/images/image_006.png)
...
| :-----------------------------------------------: | :---------------------------------------------------: |
| ![Segment Overview](outputs/images/image_009.png) | ![Basket Value Heatmap](outputs/images/image_010.png) |
...
![Dashboard Image](outputs/md-only-img/Dashboard-1.png)
